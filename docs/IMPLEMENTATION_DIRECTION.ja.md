...
- 大きい設計変更や新しい適合戦略に入る前には、少なくとも `decision memo` か `preimplementation spec` に相当する文書を用意してから進める。
- 文書ベースの議論では、候補、前提、制約、採用案、保留案を分けて書き、後から会話を読み直さなくても追える状態を目指す。
- 判断過程の記録は簡潔でよいが、「なぜその案を選んだか」が再確認できる程度の理由は残す。
