...
計算 curve が現実から離れたときは、外部補正ではなく、数理 model を見直して不足している物理現象を組み込み、更新後の ODE 系を解き直す方針を取ります。
...
- [SURROGATE_GUIDE.ja.md](SURROGATE_GUIDE.ja.md): `surrogate`、`closure`、`map`、display-model の使い分けと、現行 surrogate の代表式
