...
repository で定義している 0D ODE model を積分し、surrogate runtime や MVEM 系へ切り替えずに dyno 的に読みやすい brake torque 中心の TSV artifact を出力します。
...
- VE / wave-action closure を高回転型の自然吸気らしい傾向へ寄せる
